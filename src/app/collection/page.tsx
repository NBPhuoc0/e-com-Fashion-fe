                ...
                <div className="grid grid-cols-24 gap-3">
                    ...
                    <div className="col-span-20">
                        <div className="flex justify-end">
                            <SelectC textDefault="Sắp xếp theo" width={150} options={options} handleChange={handleChange} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='grid grid-cols-24 gap-3 pb-20'>
                <div className='col-span-4'>
                    <div className="sticky top-[114px]">
                        <ProductFilter collections={{ collectionGender, collectionColor, collectionSize, collectionPrice }} />
                    </div>
                </div>
                <div className='col-span-20'>
