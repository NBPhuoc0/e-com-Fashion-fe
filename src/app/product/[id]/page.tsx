        ...
        <div className="col-span-11">
          ...
          <div className="py-2 flex items-center">
            ...
            <div className="w-2/3 flex items-center">
              <span className="py-0.5 px-4 border text-xs text-red-600 my-0.5 mx-1.5 bg-zinc-100">
                69KT10
              </span>
                ...
                <div
                  className={`${
                    selectedColor === item.color
                      ...
                      : ""
                  } flex items-center justify-center rounded-full bg-[#ca8d3e] h-10 w-10 hover:border hover:border-slate-900 cursor-pointer`}
                  onClick={() => setSelectedColor(item.color)}
                >
                  <div
                    className={`${
                      selectedColor === item.color
                        ? "border-2 border-slate-50 h-[38px] w-[38px]"
                        : ""
                ...
                <div
                  ...
                  className={`${
                    selectedSize === item.size
                      ...
                      : ""
                  } flex justify-center items-center rounded-lg h-10 w-10 border hover:border-slate-900 cursor-pointer`}
          ...
          <div className="py-3">
            ...
            <button className="border w-full h-12 rounded-xl bg-[#FCAF17] hover:bg-[#fdc75d] shadow-2xl">
              Mua hàng
            </button>
          </div>
