...
export const jacketProductsHome = [
  {
    ...
    meta_desc:
      "Áo Khoác Gió Nữ Trượt Nước Thông Minh Cản Gió - Cản Bụi - Trượt Nước - Gấp Gọn Dễ dàng gấp gọn chỉ với vài thao tác với thiết kế túi đựng ngay trên áo.",
  ...
  },
  {
    ...
    meta_desc:
      "Áo khoác trẻ em trượt nước thông minh - Mẫu áo khoác gió cho bé thiết kế kiểu dáng năng động, thời trang, giúp giữ ấm cơ thể trẻ hiệu quả, an toàn cho da.",
...
export const jeansProductsHome = [
  {
    ...
    meta_desc:
      "Trẻ trung và tạo điểm nhấn mới cùng chiếc quấn jeans nữ baggy này của YODY. Thiết kế mới cùng màu sắc tươi sáng, chiếc quần này là lựa chọn hoàn hảo để làm mới tủ đồ jeans của nàng. Quần có chất vải bông tự nhiên nên mềm mại, thoáng, thấn hút tốt đồng thời gian giãn nhẹ nên thoải mái vận động mà khô",
  ...
  },
  {
    ...
    meta_desc:
      "Siêu thoải mái cùng Quần Jean Nữ Giấy Tencel Suông Chiết Ly. Chất mềm, nhẹ và vô cùng thoáng cho ngày hè không lo bí bách.",
  ...
  },
  {
    ...
    meta_desc:
      "Quần Jeans Nữ Coolmax Ống Vẩy Hiệu Ứng Gân Thiết kế thời trang với ống vẩy hiệu ứng gân trẻ trung, năng động, dễ dàng phối đồ phù hợp mọi phong cách. Cấu trúc sợi thông minh, điều chỉnh nhiệt độ cơ thể - giữ ấm khi lạnh và mát mẻ khi nóng mang đến cảm giác thoải mái quanh năm.",
  ...
  },
  {
    ...
    meta_desc:
      "  Quần Jeans Nữ Ống Suông Kẻ Xương Cá kiểu dệt herringbone (xương cá) độc đáo tạo nên bề mặt mới lạ, cá tính giúp bạn dễ dàng biến hóa phong cách theo sở thích. Quần ống suông che khuyết điểm chân hiệu quả, tôn lên vóc dáng thon gọn.",
